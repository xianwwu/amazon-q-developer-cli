...
mod command_execution_tests {
    ...
    use crate:::{ChatContext, ChatState};
    use crate::command::Command;
    use crate::conversation_state::ConversationState;
    use crate::input_source::InputSource;
    use crate::shared_writer::SharedWriter;
    use crate::tools::internal_command::schema::InternalCommand;
    use crate::tools::{Tool, ToolPermissions};
    use crate::ToolUseStatus;
    ...
    async fn test_execute_parsed_command_compact() -> Result<()> {
        ...
        let result = chat_context.execute_parsed_command(Command::Compact {
        ...
        if let ChatState::Compact { prompt, show_summary, help } = result {
    ...
    async fn test_tool_to_command_execution_flow() -> Result<()> {
        ...
        if let Some(ChatState::ExecuteParsedCommand(command)) = invoke_result.next_state {
            ...
            panic!("Expected ChatState::ExecuteParsedCommand, got {:?}", invoke_result.next_state);
        }
