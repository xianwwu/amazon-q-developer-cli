...
impl super::Client {
    /// Constructs a fluent builder for the [`GenerateTaskAssistPlan`](crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GenerateTaskAssistPlanOutput`](crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GenerateTaskAssistPlanError>`](crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanError)
    pub fn generate_task_assist_plan(&self) -> crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanFluentBuilder {
        crate::operation::generate_task_assist_plan::builders::GenerateTaskAssistPlanFluentBuilder::new(self.handle.clone())
    }
}
