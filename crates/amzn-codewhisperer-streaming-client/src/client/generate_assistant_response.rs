...
impl super::Client {
    /// Constructs a fluent builder for the [`GenerateAssistantResponse`](crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GenerateAssistantResponseOutput`](crate::operation::generate_assistant_response::GenerateAssistantResponseOutput) with field(s):
    ...
    pub fn generate_assistant_response(&self) -> crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder {
        crate::operation::generate_assistant_response::builders::GenerateAssistantResponseFluentBuilder::new(self.handle.clone())
    }
}
