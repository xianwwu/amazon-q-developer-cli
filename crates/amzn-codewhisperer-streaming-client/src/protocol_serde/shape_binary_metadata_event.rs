...
pub(crate) fn de_binary_metadata_event_payload(
    ...
    let result = crate::protocol_serde::shape_binary_metadata_event::de_binary_metadata_event(tokens)?
...
) -> ::std::result::Result<Option<crate::types::BinaryMetadataEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "contentChecksumType" => {
                            builder = builder.set_content_checksum_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ContentChecksumType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
