...
pub(crate) fn de_supplementary_web_links_event_payload(
    input: &[u8],
) -> ::std::result::Result<crate::types::SupplementaryWebLinksEvent, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> ::std::result::Result<Option<crate::types::SupplementaryWebLinksEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
