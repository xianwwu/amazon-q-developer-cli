...
impl GenerateAssistantResponseFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::generate_assistant_response::builders::GenerateAssistantResponseInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::generate_assistant_response::GenerateAssistantResponse::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::generate_assistant_response::GenerateAssistantResponse::orchestrate(&runtime_plugins, input).await
    }
