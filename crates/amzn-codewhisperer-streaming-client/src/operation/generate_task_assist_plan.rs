...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateTaskAssistPlanResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_generate_task_assist_plan::de_generate_task_assist_plan_http_response(response),
        ))
    }
...
impl GenerateTaskAssistPlanError {
    ...
    /// Creates the `GenerateTaskAssistPlanError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GenerateTaskAssistPlanError::ServiceQuotaExceededError`.
