...
impl Diagnostic {
    /// Tries to convert the enum instance into [`RuntimeDiagnostic`](crate::types::Diagnostic::RuntimeDiagnostic), extracting the inner [`RuntimeDiagnostic`](crate::types::RuntimeDiagnostic).
    ...
    /// Returns true if this is a [`RuntimeDiagnostic`](crate::types::Diagnostic::RuntimeDiagnostic).
    pub fn is_runtime_diagnostic(&self) -> bool {
        self.as_runtime_diagnostic().is_ok()
    }
    /// Tries to convert the enum instance into [`TextDocumentDiagnostic`](crate::types::Diagnostic::TextDocumentDiagnostic), extracting the inner [`TextDocumentDiagnostic`](crate::types::TextDocumentDiagnostic).
    /// Returns `Err(&Self)` if it can't be converted.
    ...
    /// Returns true if this is a [`TextDocumentDiagnostic`](crate::types::Diagnostic::TextDocumentDiagnostic).
