...
impl UnitTestGenerationExportContext {
    /// Creates a new builder-style object to manufacture [`UnitTestGenerationExportContext`](crate::types::UnitTestGenerationExportContext).
...
/// A builder for [`UnitTestGenerationExportContext`](crate::types::UnitTestGenerationExportContext).
...
impl UnitTestGenerationExportContextBuilder {
    ...
    /// Consumes the builder and constructs a [`UnitTestGenerationExportContext`](crate::types::UnitTestGenerationExportContext).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::UnitTestGenerationExportContext, ::aws_smithy_types::error::operation::BuildError> {
