...
impl ToolUseEvent {
    /// Creates a new builder-style object to manufacture [`ToolUseEvent`](crate::types::ToolUseEvent).
...
impl ToolUseEventBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ToolUseEvent, ::aws_smithy_types::error::operation::BuildError> {
