...
impl ResultArchiveStream {
    /// Tries to convert the enum instance into [`BinaryMetadataEvent`](crate::types::ResultArchiveStream::BinaryMetadataEvent), extracting the inner [`BinaryMetadataEvent`](crate::types::BinaryMetadataEvent).
    ...
    /// Returns true if this is a [`BinaryMetadataEvent`](crate::types::ResultArchiveStream::BinaryMetadataEvent).
    pub fn is_binary_metadata_event(&self) -> bool {
        self.as_binary_metadata_event().is_ok()
    }
    /// Tries to convert the enum instance into [`BinaryPayloadEvent`](crate::types::ResultArchiveStream::BinaryPayloadEvent), extracting the inner [`BinaryPayloadEvent`](crate::types::BinaryPayloadEvent).
    /// Returns `Err(&Self)` if it can't be converted.
    ...
    /// Returns true if this is a [`BinaryPayloadEvent`](crate::types::ResultArchiveStream::BinaryPayloadEvent).
