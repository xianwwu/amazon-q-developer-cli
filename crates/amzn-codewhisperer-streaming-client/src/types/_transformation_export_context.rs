...
impl TransformationExportContext {
    /// Creates a new builder-style object to manufacture [`TransformationExportContext`](crate::types::TransformationExportContext).
...
impl TransformationExportContextBuilder {
    ...
    /// Consumes the builder and constructs a [`TransformationExportContext`](crate::types::TransformationExportContext).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TransformationExportContext, ::aws_smithy_types::error::operation::BuildError> {
