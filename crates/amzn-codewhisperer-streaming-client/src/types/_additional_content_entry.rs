...
impl AdditionalContentEntry {
    /// Creates a new builder-style object to manufacture [`AdditionalContentEntry`](crate::types::AdditionalContentEntry).
...
impl AdditionalContentEntryBuilder {
    ...
    /// Consumes the builder and constructs a [`AdditionalContentEntry`](crate::types::AdditionalContentEntry).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AdditionalContentEntry, ::aws_smithy_types::error::operation::BuildError> {
