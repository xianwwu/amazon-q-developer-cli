...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LockServiceLinkedRole {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("LockServiceLinkedRole")
...
impl LockServiceLinkedRoleError {
    ...
    /// Creates the `LockServiceLinkedRoleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
