...
impl UnlockServiceLinkedRoleFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::unlock_service_linked_role::builders::UnlockServiceLinkedRoleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::unlock_service_linked_role::UnlockServiceLinkedRole::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::unlock_service_linked_role::UnlockServiceLinkedRole::orchestrate(&runtime_plugins, input).await
    }
