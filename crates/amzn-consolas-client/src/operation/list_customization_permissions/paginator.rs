...
/// Paginator for [`ListCustomizationPermissions`](crate::operation::list_customization_permissions::ListCustomizationPermissions)
...
impl ListCustomizationPermissionsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_customization_permissions::paginator::ListCustomizationPermissionsPaginatorItems {
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_customization_permissions_output_output_next_token(resp);
