...
impl CreateCustomization {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("codewhisperer", "CreateCustomization", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCustomizationResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_create_customization::de_create_customization_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCustomizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_customization::ser_create_customization_input(&input)?);
...
impl CreateCustomizationError {
    ...
    /// Creates the `CreateCustomizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
