    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "identityDetails" => {
                            builder = builder.set_identity_details(crate::protocol_serde::shape_identity_details::de_identity_details(tokens)?);
                        }
                        "profileName" => {
                        ...
                        "permissionUpdateRequired" => {
                            builder =
                                builder.set_permission_update_required(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
            ...
            Ok(Some(crate::serde_util::profile_correct_errors(builder).build().map_err(|err| {
