...
pub fn de_get_customization_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_customization::GetCustomizationOutput, crate::operation::get_customization::GetCustomizationError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_customization::GetCustomizationError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => crate::operation::get_customization::GetCustomizationError::ResourceNotFoundError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::CustomizationStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "errorDetails" => {
                ...
                "dataReference" => {
                    builder = builder.set_data_reference(crate::protocol_serde::shape_data_reference::de_data_reference(tokens)?);
                }
                "customizationName" => {
                ...
                "includeRepos" => {
                    builder = builder.set_include_repos(crate::protocol_serde::shape_repository_list::de_repository_list(tokens)?);
                }
