...
impl super::Client {
    /// Constructs a fluent builder for the [`LockServiceLinkedRole`](crate::operation::lock_service_linked_role::builders::LockServiceLinkedRoleFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`LockServiceLinkedRoleOutput`](crate::operation::lock_service_linked_role::LockServiceLinkedRoleOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<LockServiceLinkedRoleError>`](crate::operation::lock_service_linked_role::LockServiceLinkedRoleError)
    pub fn lock_service_linked_role(&self) -> crate::operation::lock_service_linked_role::builders::LockServiceLinkedRoleFluentBuilder {
        crate::operation::lock_service_linked_role::builders::LockServiceLinkedRoleFluentBuilder::new(self.handle.clone())
    }
}
