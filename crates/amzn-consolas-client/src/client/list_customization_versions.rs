...
impl super::Client {
    /// Constructs a fluent builder for the [`ListCustomizationVersions`](crate::operation::list_customization_versions::builders::ListCustomizationVersionsFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_customization_versions::builders::ListCustomizationVersionsFluentBuilder::into_paginator).
    ///
    ...
    /// - On success, responds with [`ListCustomizationVersionsOutput`](crate::operation::list_customization_versions::ListCustomizationVersionsOutput) with field(s):
    ...
    pub fn list_customization_versions(&self) -> crate::operation::list_customization_versions::builders::ListCustomizationVersionsFluentBuilder {
        crate::operation::list_customization_versions::builders::ListCustomizationVersionsFluentBuilder::new(self.handle.clone())
    }
}
