...
use crate::cli::chat::tools::InvokeOutput;
...
impl InternalCommand {
    ...
    pub async fn invoke(&self, _context: &Context, _updates: &mut impl Write) -> Result<InvokeOutput> {
        ...
        // Create a next state that will execute the parsed command directly
        ...
        Ok(InvokeOutput {
            output: crate::cli::chat::tools::OutputKind::Text(response),
