...
impl GenerateCodeFromCommandsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::generate_code_from_commands::builders::GenerateCodeFromCommandsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::generate_code_from_commands::GenerateCodeFromCommands::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::generate_code_from_commands::GenerateCodeFromCommands::orchestrate(&runtime_plugins, input).await
    }
