...
impl GenerateCodeFromCommandsInput {
    /// Creates a new builder-style object to manufacture [`GenerateCodeFromCommandsInput`](crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput).
...
/// A builder for [`GenerateCodeFromCommandsInput`](crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput).
...
impl GenerateCodeFromCommandsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GenerateCodeFromCommandsInput`](crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_code_from_commands::GenerateCodeFromCommandsInput {
