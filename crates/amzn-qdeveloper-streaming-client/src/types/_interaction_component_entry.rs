...
impl InteractionComponentEntry {
    /// Creates a new builder-style object to manufacture [`InteractionComponentEntry`](crate::types::InteractionComponentEntry).
...
impl InteractionComponentEntryBuilder {
    ...
    /// Interaction component
    pub fn set_interaction_component(mut self, input: ::std::option::Option<crate::types::InteractionComponent>) -> Self {
    ...
    /// Consumes the builder and constructs a [`InteractionComponentEntry`](crate::types::InteractionComponentEntry).
    /// This method will fail if any of the following fields are not set:
    /// - [`interaction_component`](crate::types::builders::InteractionComponentEntryBuilder::interaction_component)
    pub fn build(self) -> ::std::result::Result<crate::types::InteractionComponentEntry, ::aws_smithy_types::error::operation::BuildError> {
