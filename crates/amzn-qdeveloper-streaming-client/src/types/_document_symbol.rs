...
impl DocumentSymbol {
    /// Creates a new builder-style object to manufacture [`DocumentSymbol`](crate::types::DocumentSymbol).
...
impl DocumentSymbolBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DocumentSymbol, ::aws_smithy_types::error::operation::BuildError> {
