...
) -> ::std::result::Result<Option<crate::types::SupplementaryWebLink>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(crate::serde_util::supplementary_web_link_correct_errors(builder).build().map_err(
