...
) -> ::std::result::Result<Option<crate::types::InteractionComponent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "infrastructureUpdate" => {
                            builder = builder
                                .set_infrastructure_update(crate::protocol_serde::shape_infrastructure_update::de_infrastructure_update(tokens)?);
                        }
                        "progress" => {
                        ...
                        "taskReference" => {
                            builder = builder.set_task_reference(crate::protocol_serde::shape_task_reference::de_task_reference(tokens)?);
                        }
                        "suggestions" => {
                            builder = builder.set_suggestions(crate::protocol_serde::shape_suggestions::de_suggestions(tokens)?);
                        }
                        "section" => {
