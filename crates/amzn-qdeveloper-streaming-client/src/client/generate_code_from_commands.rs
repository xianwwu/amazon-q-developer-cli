...
impl super::Client {
    /// Constructs a fluent builder for the [`GenerateCodeFromCommands`](crate::operation::generate_code_from_commands::builders::GenerateCodeFromCommandsFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GenerateCodeFromCommandsOutput`](crate::operation::generate_code_from_commands::GenerateCodeFromCommandsOutput) with field(s):
    ...
    pub fn generate_code_from_commands(&self) -> crate::operation::generate_code_from_commands::builders::GenerateCodeFromCommandsFluentBuilder {
        crate::operation::generate_code_from_commands::builders::GenerateCodeFromCommandsFluentBuilder::new(self.handle.clone())
    }
}
