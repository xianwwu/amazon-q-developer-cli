...
impl super::Client {
    ...
    ///   - [`send_message_response(EventReceiver<ChatResponseStream, ChatResponseStreamError>)`](crate::operation::send_message::SendMessageOutput::send_message_response): Streaming events from UniDirectional Streaming Conversational APIs.
