...
pub fn de_get_transformation_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_transformation::GetTransformationOutput, crate::operation::get_transformation::GetTransformationError>
{
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_transformation::GetTransformationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServerException" => crate::operation::get_transformation::GetTransformationError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::get_transformation::GetTransformationError::ResourceNotFoundError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "transformationJob" => {
                    builder = builder.set_transformation_job(crate::protocol_serde::shape_transformation_job::de_transformation_job(tokens)?);
                }
