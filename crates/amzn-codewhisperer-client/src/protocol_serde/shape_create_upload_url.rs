...
pub fn de_create_upload_url_http_error(
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => crate::operation::create_upload_url::CreateUploadUrlError::ResourceNotFoundError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::create_upload_url::CreateUploadUrlError::ServiceQuotaExceededError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
