...
pub fn de_get_code_fix_job_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_code_fix_job::GetCodeFixJobOutput, crate::operation::get_code_fix_job::GetCodeFixJobError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_code_fix_job::GetCodeFixJobError::unhandled(generic)),
    };
                ...
                "jobStatus" => {
                    builder = builder.set_job_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::CodeFixJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "suggestedFix" => {
                    builder = builder.set_suggested_fix(crate::protocol_serde::shape_suggested_fix::de_suggested_fix(tokens)?);
                }
