...
> {
    ...
    Err(match error_code {
        "InternalServerException" => crate::operation::get_transformation_plan::GetTransformationPlanError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_transformation_plan::GetTransformationPlanError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_transformation_plan::GetTransformationPlanError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "AccessDeniedException" => crate::operation::get_transformation_plan::GetTransformationPlanError::AccessDeniedError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::get_transformation_plan::GetTransformationPlanError::ResourceNotFoundError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_transformation_plan::builders::GetTransformationPlanOutputBuilder::default();
        output = crate::protocol_serde::shape_get_transformation_plan::de_get_transformation_plan(_response_body, output)
            .map_err(crate::operation::get_transformation_plan::GetTransformationPlanError::unhandled)?;
...
pub fn ser_get_transformation_plan_input(
    ...
    crate::protocol_serde::shape_get_transformation_plan_input::ser_get_transformation_plan_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "transformationPlan" => {
                    builder = builder.set_transformation_plan(crate::protocol_serde::shape_transformation_plan::de_transformation_plan(tokens)?);
                }
