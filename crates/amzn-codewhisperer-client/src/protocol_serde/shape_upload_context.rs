...
pub fn ser_upload_context(
    ...
    match input {
        crate::types::UploadContext::TaskAssistPlanningUploadContext(inner) => {
            ...
            crate::protocol_serde::shape_task_assist_planning_upload_context::ser_task_assist_planning_upload_context(&mut object_1, inner)?;
            object_1.finish();
        }
        crate::types::UploadContext::TransformationUploadContext(inner) => {
            ...
            crate::protocol_serde::shape_transformation_upload_context::ser_transformation_upload_context(&mut object_2, inner)?;
            object_2.finish();
        }
        crate::types::UploadContext::CodeAnalysisUploadContext(inner) => {
            ...
            crate::protocol_serde::shape_code_analysis_upload_context::ser_code_analysis_upload_context(&mut object_3, inner)?;
            object_3.finish();
        }
        ...
        crate::types::UploadContext::WorkspaceContextUploadContext(inner) => {
            ...
            crate::protocol_serde::shape_workspace_context_upload_context::ser_workspace_context_upload_context(&mut object_5, inner)?;
            object_5.finish();
        }
