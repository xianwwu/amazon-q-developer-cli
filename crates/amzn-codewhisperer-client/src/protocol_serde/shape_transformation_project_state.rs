...
pub fn ser_transformation_project_state(
    ...
    if let Some(var_4) = &input.platform_config {
        ...
        crate::protocol_serde::shape_transformation_platform_config::ser_transformation_platform_config(&mut object_5, var_4)?;
        object_5.finish();
    }
...
) -> ::std::result::Result<Option<crate::types::TransformationProjectState>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "language" => {
                            builder = builder.set_language(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TransformationLanguage::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "runtimeEnv" => {
