...
impl SendTelemetryEventInput {
    /// Creates a new builder-style object to manufacture [`SendTelemetryEventInput`](crate::operation::send_telemetry_event::SendTelemetryEventInput).
...
/// A builder for [`SendTelemetryEventInput`](crate::operation::send_telemetry_event::SendTelemetryEventInput).
...
impl SendTelemetryEventInputBuilder {
    ...
    /// Consumes the builder and constructs a [`SendTelemetryEventInput`](crate::operation::send_telemetry_event::SendTelemetryEventInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::send_telemetry_event::SendTelemetryEventInput, ::aws_smithy_types::error::operation::BuildError>
    {
