...
impl ListCodeAnalysisFindingsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_code_analysis_findings::ListCodeAnalysisFindings::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_code_analysis_findings::ListCodeAnalysisFindings::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_code_analysis_findings::paginator::ListCodeAnalysisFindingsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_code_analysis_findings::paginator::ListCodeAnalysisFindingsPaginator {
        crate::operation::list_code_analysis_findings::paginator::ListCodeAnalysisFindingsPaginator::new(self.handle, self.inner)
    }
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_code_analysis_findings_schema(mut self, input: ::std::option::Option<crate::types::CodeAnalysisFindingsSchema>) -> Self {
        self.inner = self.inner.set_code_analysis_findings_schema(input);
        self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_code_analysis_findings_schema(&self) -> &::std::option::Option<crate::types::CodeAnalysisFindingsSchema> {
