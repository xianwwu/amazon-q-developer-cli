...
impl ListCodeAnalysisFindingsInput {
    /// Creates a new builder-style object to manufacture [`ListCodeAnalysisFindingsInput`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsInput).
...
/// A builder for [`ListCodeAnalysisFindingsInput`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsInput).
...
impl ListCodeAnalysisFindingsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListCodeAnalysisFindingsInput`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsInput {
            job_id: self.job_id,
