...
impl GetTestGenerationInput {
    /// Creates a new builder-style object to manufacture [`GetTestGenerationInput`](crate::operation::get_test_generation::GetTestGenerationInput).
...
/// A builder for [`GetTestGenerationInput`](crate::operation::get_test_generation::GetTestGenerationInput).
...
impl GetTestGenerationInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetTestGenerationInput`](crate::operation::get_test_generation::GetTestGenerationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_test_generation::GetTestGenerationInput, ::aws_smithy_types::error::operation::BuildError> {
