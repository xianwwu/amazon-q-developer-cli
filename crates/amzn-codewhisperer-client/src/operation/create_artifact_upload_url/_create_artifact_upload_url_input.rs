...
impl CreateArtifactUploadUrlInput {
    /// Creates a new builder-style object to manufacture [`CreateArtifactUploadUrlInput`](crate::operation::create_artifact_upload_url::CreateArtifactUploadUrlInput).
...
/// A builder for [`CreateArtifactUploadUrlInput`](crate::operation::create_artifact_upload_url::CreateArtifactUploadUrlInput).
...
impl CreateArtifactUploadUrlInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateArtifactUploadUrlInput`](crate::operation::create_artifact_upload_url::CreateArtifactUploadUrlInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_artifact_upload_url::CreateArtifactUploadUrlInput {
