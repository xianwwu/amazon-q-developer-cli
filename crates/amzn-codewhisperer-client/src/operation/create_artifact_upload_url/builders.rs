...
impl CreateArtifactUploadUrlFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_artifact_upload_url::builders::CreateArtifactUploadUrlInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_artifact_upload_url::CreateArtifactUploadUrl::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_artifact_upload_url::CreateArtifactUploadUrl::orchestrate(&runtime_plugins, input).await
    }
