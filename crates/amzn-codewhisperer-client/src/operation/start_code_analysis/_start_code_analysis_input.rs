...
pub struct StartCodeAnalysisInput {
    #[allow(missing_docs)] // documentation missing in model
    pub artifacts: ::std::option::Option<::std::collections::HashMap<crate::types::ArtifactType, ::std::string::String>>,
...
impl StartCodeAnalysisInput {
    #[allow(missing_docs)] // documentation missing in model
    pub fn artifacts(&self) -> ::std::option::Option<&::std::collections::HashMap<crate::types::ArtifactType, ::std::string::String>> {
...
impl StartCodeAnalysisInput {
    /// Creates a new builder-style object to manufacture [`StartCodeAnalysisInput`](crate::operation::start_code_analysis::StartCodeAnalysisInput).
...
/// A builder for [`StartCodeAnalysisInput`](crate::operation::start_code_analysis::StartCodeAnalysisInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartCodeAnalysisInputBuilder {
    pub(crate) artifacts: ::std::option::Option<::std::collections::HashMap<crate::types::ArtifactType, ::std::string::String>>,
...
impl StartCodeAnalysisInputBuilder {
    ...
    ///
    pub fn artifacts(mut self, k: crate::types::ArtifactType, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_artifacts(&self) -> &::std::option::Option<::std::collections::HashMap<crate::types::ArtifactType, ::std::string::String>> {
        &self.artifacts
    }
    /// Programming Languages supported by CodeWhisperer
    ...
    /// Consumes the builder and constructs a [`StartCodeAnalysisInput`](crate::operation::start_code_analysis::StartCodeAnalysisInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::start_code_analysis::StartCodeAnalysisInput, ::aws_smithy_types::error::operation::BuildError> {
