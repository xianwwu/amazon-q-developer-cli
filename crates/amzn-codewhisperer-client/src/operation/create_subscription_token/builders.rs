...
impl CreateSubscriptionTokenFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_subscription_token::builders::CreateSubscriptionTokenInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_subscription_token::CreateSubscriptionToken::operation_runtime_plugins(
