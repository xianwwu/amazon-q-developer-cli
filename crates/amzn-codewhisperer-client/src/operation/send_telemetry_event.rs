        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::send_telemetry_event::SendTelemetryEventInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendTelemetryEvent {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendTelemetryEvent")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendTelemetryEventResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_send_telemetry_event::de_send_telemetry_event_http_response(status, headers, body)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendTelemetryEventRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_send_telemetry_event::ser_send_telemetry_event_input(&input)?);
...
impl SendTelemetryEventError {
    ...
    /// Creates the `SendTelemetryEventError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
