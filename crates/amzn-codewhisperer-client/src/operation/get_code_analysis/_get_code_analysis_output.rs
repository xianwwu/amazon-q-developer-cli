...
impl GetCodeAnalysisOutput {
    /// Creates a new builder-style object to manufacture [`GetCodeAnalysisOutput`](crate::operation::get_code_analysis::GetCodeAnalysisOutput).
...
/// A builder for [`GetCodeAnalysisOutput`](crate::operation::get_code_analysis::GetCodeAnalysisOutput).
...
impl GetCodeAnalysisOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetCodeAnalysisOutput`](crate::operation::get_code_analysis::GetCodeAnalysisOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`status`](crate::operation::get_code_analysis::builders::GetCodeAnalysisOutputBuilder::status)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_code_analysis::GetCodeAnalysisOutput, ::aws_smithy_types::error::operation::BuildError> {
