...
impl ListAvailableProfilesOutput {
    /// Creates a new builder-style object to manufacture [`ListAvailableProfilesOutput`](crate::operation::list_available_profiles::ListAvailableProfilesOutput).
...
/// A builder for [`ListAvailableProfilesOutput`](crate::operation::list_available_profiles::ListAvailableProfilesOutput).
...
impl ListAvailableProfilesOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListAvailableProfilesOutput`](crate::operation::list_available_profiles::ListAvailableProfilesOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`profiles`](crate::operation::list_available_profiles::builders::ListAvailableProfilesOutputBuilder::profiles)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_available_profiles::ListAvailableProfilesOutput, ::aws_smithy_types::error::operation::BuildError>
    {
