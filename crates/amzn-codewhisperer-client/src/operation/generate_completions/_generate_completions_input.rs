...
impl GenerateCompletionsInput {
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.prediction_types.is_none()`.
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.supplemental_contexts.is_none()`.
...
impl GenerateCompletionsInput {
    /// Creates a new builder-style object to manufacture [`GenerateCompletionsInput`](crate::operation::generate_completions::GenerateCompletionsInput).
...
/// A builder for [`GenerateCompletionsInput`](crate::operation::generate_completions::GenerateCompletionsInput).
...
impl GenerateCompletionsInputBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_prediction_types`](Self::set_prediction_types).
    ///
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_prediction_types(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::PredictionType>>) -> Self {
    ...
    ///
    /// To override the contents of this collection use [`set_supplemental_contexts`](Self::set_supplemental_contexts).
    ///
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_supplemental_contexts(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::SupplementalContext>>) -> Self {
        self.supplemental_contexts = input;
        self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_supplemental_contexts(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SupplementalContext>> {
    ...
    /// Consumes the builder and constructs a [`GenerateCompletionsInput`](crate::operation::generate_completions::GenerateCompletionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::generate_completions::GenerateCompletionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
