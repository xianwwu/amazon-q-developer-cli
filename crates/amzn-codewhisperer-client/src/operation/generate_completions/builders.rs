...
impl GenerateCompletionsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::generate_completions::paginator::GenerateCompletionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
