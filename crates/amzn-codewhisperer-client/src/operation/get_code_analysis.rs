...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCodeAnalysis {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCodeAnalysis")
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCodeAnalysisRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_code_analysis::ser_get_code_analysis_input(&input)?);
...
impl GetCodeAnalysisError {
    ...
    /// Creates the `GetCodeAnalysisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
