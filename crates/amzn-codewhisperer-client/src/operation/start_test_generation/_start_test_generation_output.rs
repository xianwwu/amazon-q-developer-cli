...
impl StartTestGenerationOutput {
    /// Creates a new builder-style object to manufacture [`StartTestGenerationOutput`](crate::operation::start_test_generation::StartTestGenerationOutput).
...
/// A builder for [`StartTestGenerationOutput`](crate::operation::start_test_generation::StartTestGenerationOutput).
...
impl StartTestGenerationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartTestGenerationOutput`](crate::operation::start_test_generation::StartTestGenerationOutput).
