...
impl GetTaskAssistCodeGenerationFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_task_assist_code_generation::builders::GetTaskAssistCodeGenerationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGeneration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_task_assist_code_generation::GetTaskAssistCodeGeneration::orchestrate(&runtime_plugins, input).await
    }
