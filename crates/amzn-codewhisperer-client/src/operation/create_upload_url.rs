...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUploadUrlRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_upload_url::ser_create_upload_url_input(&input)?);
...
impl CreateUploadUrlError {
    ...
    /// Creates the `CreateUploadUrlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
