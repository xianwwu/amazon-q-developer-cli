...
impl StartTaskAssistCodeGenerationInput {
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.task_assist_plan.is_none()`.
...
impl StartTaskAssistCodeGenerationInput {
    /// Creates a new builder-style object to manufacture [`StartTaskAssistCodeGenerationInput`](crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput).
    pub fn builder() -> crate::operation::start_task_assist_code_generation::builders::StartTaskAssistCodeGenerationInputBuilder {
        crate::operation::start_task_assist_code_generation::builders::StartTaskAssistCodeGenerationInputBuilder::default()
    }
}

/// A builder for [`StartTaskAssistCodeGenerationInput`](crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput).
...
impl StartTaskAssistCodeGenerationInputBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_task_assist_plan`](Self::set_task_assist_plan).
    ///
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_task_assist_plan(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::TaskAssistPlanStep>>) -> Self {
    ...
    /// Consumes the builder and constructs a [`StartTaskAssistCodeGenerationInput`](crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::start_task_assist_code_generation::StartTaskAssistCodeGenerationInput {
