...
impl super::Client {
    /// Constructs a fluent builder for the [`StartTestGeneration`](crate::operation::start_test_generation::builders::StartTestGenerationFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`StartTestGenerationOutput`](crate::operation::start_test_generation::StartTestGenerationOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<StartTestGenerationError>`](crate::operation::start_test_generation::StartTestGenerationError)
    pub fn start_test_generation(&self) -> crate::operation::start_test_generation::builders::StartTestGenerationFluentBuilder {
