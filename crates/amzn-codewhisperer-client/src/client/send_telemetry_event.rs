...
impl super::Client {
    /// Constructs a fluent builder for the [`SendTelemetryEvent`](crate::operation::send_telemetry_event::builders::SendTelemetryEventFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`SendTelemetryEventOutput`](crate::operation::send_telemetry_event::SendTelemetryEventOutput)
    /// - On failure, responds with [`SdkError<SendTelemetryEventError>`](crate::operation::send_telemetry_event::SendTelemetryEventError)
    pub fn send_telemetry_event(&self) -> crate::operation::send_telemetry_event::builders::SendTelemetryEventFluentBuilder {
