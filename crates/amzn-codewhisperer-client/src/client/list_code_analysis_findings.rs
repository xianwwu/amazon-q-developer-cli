...
impl super::Client {
    /// Constructs a fluent builder for the [`ListCodeAnalysisFindings`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::into_paginator).
    ///
    ...
    /// - On success, responds with [`ListCodeAnalysisFindingsOutput`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsOutput) with field(s):
    ...
    pub fn list_code_analysis_findings(&self) -> crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder {
        crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::new(self.handle.clone())
    }
}
