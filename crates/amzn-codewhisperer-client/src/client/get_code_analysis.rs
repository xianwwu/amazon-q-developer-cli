...
impl super::Client {
    /// Constructs a fluent builder for the [`GetCodeAnalysis`](crate::operation::get_code_analysis::builders::GetCodeAnalysisFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GetCodeAnalysisOutput`](crate::operation::get_code_analysis::GetCodeAnalysisOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GetCodeAnalysisError>`](crate::operation::get_code_analysis::GetCodeAnalysisError)
