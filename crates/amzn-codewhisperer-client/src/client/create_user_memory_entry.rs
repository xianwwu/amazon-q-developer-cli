...
impl super::Client {
    /// Constructs a fluent builder for the [`CreateUserMemoryEntry`](crate::operation::create_user_memory_entry::builders::CreateUserMemoryEntryFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`CreateUserMemoryEntryOutput`](crate::operation::create_user_memory_entry::CreateUserMemoryEntryOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<CreateUserMemoryEntryError>`](crate::operation::create_user_memory_entry::CreateUserMemoryEntryError)
    pub fn create_user_memory_entry(&self) -> crate::operation::create_user_memory_entry::builders::CreateUserMemoryEntryFluentBuilder {
        crate::operation::create_user_memory_entry::builders::CreateUserMemoryEntryFluentBuilder::new(self.handle.clone())
    }
}
