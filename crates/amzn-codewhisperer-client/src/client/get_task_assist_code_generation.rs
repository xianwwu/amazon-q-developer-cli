...
impl super::Client {
    /// Constructs a fluent builder for the [`GetTaskAssistCodeGeneration`](crate::operation::get_task_assist_code_generation::builders::GetTaskAssistCodeGenerationFluentBuilder) operation.
    ///
    ...
    pub fn get_task_assist_code_generation(
        ...
        crate::operation::get_task_assist_code_generation::builders::GetTaskAssistCodeGenerationFluentBuilder::new(self.handle.clone())
    }
}
