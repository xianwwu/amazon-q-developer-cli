...
impl super::Client {
    /// Constructs a fluent builder for the [`ListFeatureEvaluations`](crate::operation::list_feature_evaluations::builders::ListFeatureEvaluationsFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`ListFeatureEvaluationsOutput`](crate::operation::list_feature_evaluations::ListFeatureEvaluationsOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<ListFeatureEvaluationsError>`](crate::operation::list_feature_evaluations::ListFeatureEvaluationsError)
    pub fn list_feature_evaluations(&self) -> crate::operation::list_feature_evaluations::builders::ListFeatureEvaluationsFluentBuilder {
        crate::operation::list_feature_evaluations::builders::ListFeatureEvaluationsFluentBuilder::new(self.handle.clone())
    }
}
