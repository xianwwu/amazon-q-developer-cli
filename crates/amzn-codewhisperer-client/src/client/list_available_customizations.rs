...
impl super::Client {
    /// Constructs a fluent builder for the [`ListAvailableCustomizations`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::into_paginator).
    ///
    ...
    pub fn list_available_customizations(
        ...
        crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::new(self.handle.clone())
    }
}
