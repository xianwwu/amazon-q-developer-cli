...
impl super::Client {
    /// Constructs a fluent builder for the [`StartCodeFixJob`](crate::operation::start_code_fix_job::builders::StartCodeFixJobFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`StartCodeFixJobOutput`](crate::operation::start_code_fix_job::StartCodeFixJobOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<StartCodeFixJobError>`](crate::operation::start_code_fix_job::StartCodeFixJobError)
