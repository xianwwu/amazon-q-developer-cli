...
impl super::Client {
    /// Constructs a fluent builder for the [`GetTransformationPlan`](crate::operation::get_transformation_plan::builders::GetTransformationPlanFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GetTransformationPlanOutput`](crate::operation::get_transformation_plan::GetTransformationPlanOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GetTransformationPlanError>`](crate::operation::get_transformation_plan::GetTransformationPlanError)
    pub fn get_transformation_plan(&self) -> crate::operation::get_transformation_plan::builders::GetTransformationPlanFluentBuilder {
        crate::operation::get_transformation_plan::builders::GetTransformationPlanFluentBuilder::new(self.handle.clone())
    }
}
