...
impl super::Client {
    /// Constructs a fluent builder for the [`GetTestGeneration`](crate::operation::get_test_generation::builders::GetTestGenerationFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GetTestGenerationOutput`](crate::operation::get_test_generation::GetTestGenerationOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GetTestGenerationError>`](crate::operation::get_test_generation::GetTestGenerationError)
    pub fn get_test_generation(&self) -> crate::operation::get_test_generation::builders::GetTestGenerationFluentBuilder {
