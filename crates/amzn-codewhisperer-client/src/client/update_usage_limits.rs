...
impl super::Client {
    /// Constructs a fluent builder for the [`UpdateUsageLimits`](crate::operation::update_usage_limits::builders::UpdateUsageLimitsFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`UpdateUsageLimitsOutput`](crate::operation::update_usage_limits::UpdateUsageLimitsOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<UpdateUsageLimitsError>`](crate::operation::update_usage_limits::UpdateUsageLimitsError)
    pub fn update_usage_limits(&self) -> crate::operation::update_usage_limits::builders::UpdateUsageLimitsFluentBuilder {
