...
impl super::Client {
    /// Constructs a fluent builder for the [`ListAvailableModels`](crate::operation::list_available_models::builders::ListAvailableModelsFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_available_models::builders::ListAvailableModelsFluentBuilder::into_paginator).
    ///
    ...
    /// - On success, responds with [`ListAvailableModelsOutput`](crate::operation::list_available_models::ListAvailableModelsOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<ListAvailableModelsError>`](crate::operation::list_available_models::ListAvailableModelsError)
    pub fn list_available_models(&self) -> crate::operation::list_available_models::builders::ListAvailableModelsFluentBuilder {
