...
impl super::Client {
    /// Constructs a fluent builder for the [`PushTelemetryEvent`](crate::operation::push_telemetry_event::builders::PushTelemetryEventFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`PushTelemetryEventOutput`](crate::operation::push_telemetry_event::PushTelemetryEventOutput)
    /// - On failure, responds with [`SdkError<PushTelemetryEventError>`](crate::operation::push_telemetry_event::PushTelemetryEventError)
    pub fn push_telemetry_event(&self) -> crate::operation::push_telemetry_event::builders::PushTelemetryEventFluentBuilder {
