...
impl super::Client {
    /// Constructs a fluent builder for the [`ResumeTransformation`](crate::operation::resume_transformation::builders::ResumeTransformationFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`ResumeTransformationOutput`](crate::operation::resume_transformation::ResumeTransformationOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<ResumeTransformationError>`](crate::operation::resume_transformation::ResumeTransformationError)
    pub fn resume_transformation(&self) -> crate::operation::resume_transformation::builders::ResumeTransformationFluentBuilder {
