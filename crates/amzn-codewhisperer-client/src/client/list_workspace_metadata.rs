...
impl super::Client {
    /// Constructs a fluent builder for the [`ListWorkspaceMetadata`](crate::operation::list_workspace_metadata::builders::ListWorkspaceMetadataFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_workspace_metadata::builders::ListWorkspaceMetadataFluentBuilder::into_paginator).
    ///
    ...
    /// - On success, responds with [`ListWorkspaceMetadataOutput`](crate::operation::list_workspace_metadata::ListWorkspaceMetadataOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<ListWorkspaceMetadataError>`](crate::operation::list_workspace_metadata::ListWorkspaceMetadataError)
    pub fn list_workspace_metadata(&self) -> crate::operation::list_workspace_metadata::builders::ListWorkspaceMetadataFluentBuilder {
        crate::operation::list_workspace_metadata::builders::ListWorkspaceMetadataFluentBuilder::new(self.handle.clone())
    }
}
