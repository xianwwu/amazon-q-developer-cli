...
impl super::Client {
    /// Constructs a fluent builder for the [`DeleteTaskAssistConversation`](crate::operation::delete_task_assist_conversation::builders::DeleteTaskAssistConversationFluentBuilder) operation.
    ///
    ...
    pub fn delete_task_assist_conversation(
        ...
        crate::operation::delete_task_assist_conversation::builders::DeleteTaskAssistConversationFluentBuilder::new(self.handle.clone())
    }
}
