...
impl super::Client {
    /// Constructs a fluent builder for the [`ListUserMemoryEntries`](crate::operation::list_user_memory_entries::builders::ListUserMemoryEntriesFluentBuilder) operation.
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_user_memory_entries::builders::ListUserMemoryEntriesFluentBuilder::into_paginator).
    ///
    ...
    /// - On success, responds with [`ListUserMemoryEntriesOutput`](crate::operation::list_user_memory_entries::ListUserMemoryEntriesOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<ListUserMemoryEntriesError>`](crate::operation::list_user_memory_entries::ListUserMemoryEntriesError)
    pub fn list_user_memory_entries(&self) -> crate::operation::list_user_memory_entries::builders::ListUserMemoryEntriesFluentBuilder {
        crate::operation::list_user_memory_entries::builders::ListUserMemoryEntriesFluentBuilder::new(self.handle.clone())
    }
}
