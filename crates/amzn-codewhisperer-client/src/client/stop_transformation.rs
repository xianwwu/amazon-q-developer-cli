...
impl super::Client {
    /// Constructs a fluent builder for the [`StopTransformation`](crate::operation::stop_transformation::builders::StopTransformationFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`StopTransformationOutput`](crate::operation::stop_transformation::StopTransformationOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<StopTransformationError>`](crate::operation::stop_transformation::StopTransformationError)
    pub fn stop_transformation(&self) -> crate::operation::stop_transformation::builders::StopTransformationFluentBuilder {
