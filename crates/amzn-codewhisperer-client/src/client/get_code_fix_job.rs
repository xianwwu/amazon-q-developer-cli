...
impl super::Client {
    /// Constructs a fluent builder for the [`GetCodeFixJob`](crate::operation::get_code_fix_job::builders::GetCodeFixJobFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_code_fix_job::builders::GetCodeFixJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_code_fix_job::builders::GetCodeFixJobFluentBuilder::set_job_id):<br>required: **true**<br>(undocumented)<br>
    ...
    /// - On success, responds with [`GetCodeFixJobOutput`](crate::operation::get_code_fix_job::GetCodeFixJobOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GetCodeFixJobError>`](crate::operation::get_code_fix_job::GetCodeFixJobError)
