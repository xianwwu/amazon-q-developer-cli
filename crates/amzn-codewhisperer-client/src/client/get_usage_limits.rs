...
impl super::Client {
    /// Constructs a fluent builder for the [`GetUsageLimits`](crate::operation::get_usage_limits::builders::GetUsageLimitsFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`GetUsageLimitsOutput`](crate::operation::get_usage_limits::GetUsageLimitsOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<GetUsageLimitsError>`](crate::operation::get_usage_limits::GetUsageLimitsError)
