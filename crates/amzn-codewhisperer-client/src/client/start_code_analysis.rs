...
impl super::Client {
    /// Constructs a fluent builder for the [`StartCodeAnalysis`](crate::operation::start_code_analysis::builders::StartCodeAnalysisFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`artifacts(ArtifactType, impl Into<String>)`](crate::operation::start_code_analysis::builders::StartCodeAnalysisFluentBuilder::artifacts) / [`set_artifacts(Option<HashMap::<ArtifactType, String>>)`](crate::operation::start_code_analysis::builders::StartCodeAnalysisFluentBuilder::set_artifacts):<br>required: **true**<br>(undocumented)<br>
    ...
    /// - On success, responds with [`StartCodeAnalysisOutput`](crate::operation::start_code_analysis::StartCodeAnalysisOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<StartCodeAnalysisError>`](crate::operation::start_code_analysis::StartCodeAnalysisError)
    pub fn start_code_analysis(&self) -> crate::operation::start_code_analysis::builders::StartCodeAnalysisFluentBuilder {
