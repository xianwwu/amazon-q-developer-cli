...
impl super::Client {
    /// Constructs a fluent builder for the [`StartTransformation`](crate::operation::start_transformation::builders::StartTransformationFluentBuilder) operation.
    ///
    ...
    /// - On success, responds with [`StartTransformationOutput`](crate::operation::start_transformation::StartTransformationOutput) with field(s):
    ...
    /// - On failure, responds with [`SdkError<StartTransformationError>`](crate::operation::start_transformation::StartTransformationError)
    pub fn start_transformation(&self) -> crate::operation::start_transformation::builders::StartTransformationFluentBuilder {
