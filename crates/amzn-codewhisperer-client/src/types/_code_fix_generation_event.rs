...
impl CodeFixGenerationEvent {
    /// Creates a new builder-style object to manufacture [`CodeFixGenerationEvent`](crate::types::CodeFixGenerationEvent).
...
impl CodeFixGenerationEventBuilder {
    ...
    /// Consumes the builder and constructs a [`CodeFixGenerationEvent`](crate::types::CodeFixGenerationEvent).
    /// This method will fail if any of the following fields are not set:
    /// - [`job_id`](crate::types::builders::CodeFixGenerationEventBuilder::job_id)
    pub fn build(self) -> ::std::result::Result<crate::types::CodeFixGenerationEvent, ::aws_smithy_types::error::operation::BuildError> {
