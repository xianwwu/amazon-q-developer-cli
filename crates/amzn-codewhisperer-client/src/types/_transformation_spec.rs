...
impl TransformationSpec {
    /// Creates a new builder-style object to manufacture [`TransformationSpec`](crate::types::TransformationSpec).
...
impl TransformationSpecBuilder {
    ...
    /// Consumes the builder and constructs a [`TransformationSpec`](crate::types::TransformationSpec).
