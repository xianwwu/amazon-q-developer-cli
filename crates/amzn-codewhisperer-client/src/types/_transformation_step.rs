...
impl TransformationStep {
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.progress_updates.is_none()`.
...
impl TransformationStep {
    /// Creates a new builder-style object to manufacture [`TransformationStep`](crate::types::TransformationStep).
...
impl TransformationStepBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_progress_updates`](Self::set_progress_updates).
    ///
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_progress_updates(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::TransformationProgressUpdate>>) -> Self {
        self.progress_updates = input;
        self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_progress_updates(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::TransformationProgressUpdate>> {
    ...
    /// Consumes the builder and constructs a [`TransformationStep`](crate::types::TransformationStep).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TransformationStep, ::aws_smithy_types::error::operation::BuildError> {
