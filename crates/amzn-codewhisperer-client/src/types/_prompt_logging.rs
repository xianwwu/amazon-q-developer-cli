...
impl PromptLogging {
    /// Creates a new builder-style object to manufacture [`PromptLogging`](crate::types::PromptLogging).
...
impl PromptLoggingBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::PromptLogging, ::aws_smithy_types::error::operation::BuildError> {
