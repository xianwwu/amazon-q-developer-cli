...
impl CursorState {
    /// Tries to convert the enum instance into [`Position`](crate::types::CursorState::Position), extracting the inner [`Position`](crate::types::Position).
    ...
    /// Tries to convert the enum instance into [`Range`](crate::types::CursorState::Range), extracting the inner [`Range`](crate::types::Range).
    /// Returns `Err(&Self)` if it can't be converted.
