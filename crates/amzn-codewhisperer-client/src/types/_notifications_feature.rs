...
impl NotificationsFeature {
    /// Creates a new builder-style object to manufacture [`NotificationsFeature`](crate::types::NotificationsFeature).
...
impl NotificationsFeatureBuilder {
    ...
    /// Consumes the builder and constructs a [`NotificationsFeature`](crate::types::NotificationsFeature).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::NotificationsFeature, ::aws_smithy_types::error::operation::BuildError> {
