...
impl DocGenerationEvent {
    /// Creates a new builder-style object to manufacture [`DocGenerationEvent`](crate::types::DocGenerationEvent).
...
impl DocGenerationEventBuilder {
    ...
    /// Consumes the builder and constructs a [`DocGenerationEvent`](crate::types::DocGenerationEvent).
    /// This method will fail if any of the following fields are not set:
    /// - [`conversation_id`](crate::types::builders::DocGenerationEventBuilder::conversation_id)
    pub fn build(self) -> ::std::result::Result<crate::types::DocGenerationEvent, ::aws_smithy_types::error::operation::BuildError> {
