...
impl ::std::convert::From<&str> for TransformationStepStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformationStepStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl TransformationStepStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["COMPLETED", "CREATED", "FAILED", "PARTIALLY_COMPLETED", "PAUSED", "SKIPPED", "STOPPED"]
    }
}
