...
/// When writing a match expression against `TransformationJavaRuntimeEnv`, it is important to ensure
...
impl ::std::convert::From<&str> for TransformationJavaRuntimeEnv {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformationJavaRuntimeEnv::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
