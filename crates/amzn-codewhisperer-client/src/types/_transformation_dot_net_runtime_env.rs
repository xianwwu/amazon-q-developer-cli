...
/// When writing a match expression against `TransformationDotNetRuntimeEnv`, it is important to ensure
...
impl ::std::convert::From<&str> for TransformationDotNetRuntimeEnv {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformationDotNetRuntimeEnv::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl TransformationDotNetRuntimeEnv {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["NET_5_0", "NET_6_0", "NET_7_0", "NET_8_0", "NET_9_0", "NET_STANDARD_2_0"]
    }
}
