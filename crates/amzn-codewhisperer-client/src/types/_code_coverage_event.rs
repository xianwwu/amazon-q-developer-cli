...
impl CodeCoverageEvent {
    /// Creates a new builder-style object to manufacture [`CodeCoverageEvent`](crate::types::CodeCoverageEvent).
...
impl CodeCoverageEventBuilder {
    ...
    /// Consumes the builder and constructs a [`CodeCoverageEvent`](crate::types::CodeCoverageEvent).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CodeCoverageEvent, ::aws_smithy_types::error::operation::BuildError> {
