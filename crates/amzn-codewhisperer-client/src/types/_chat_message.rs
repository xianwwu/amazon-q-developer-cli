...
impl ChatMessage {
    /// Tries to convert the enum instance into [`AssistantResponseMessage`](crate::types::ChatMessage::AssistantResponseMessage), extracting the inner [`AssistantResponseMessage`](crate::types::AssistantResponseMessage).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_assistant_response_message(&self) -> ::std::result::Result<&crate::types::AssistantResponseMessage, &Self> {
    ...
    /// Returns true if this is a [`AssistantResponseMessage`](crate::types::ChatMessage::AssistantResponseMessage).
    pub fn is_assistant_response_message(&self) -> bool {
        self.as_assistant_response_message().is_ok()
    }
    /// Tries to convert the enum instance into [`UserInputMessage`](crate::types::ChatMessage::UserInputMessage), extracting the inner [`UserInputMessage`](crate::types::UserInputMessage).
    /// Returns `Err(&Self)` if it can't be converted.
