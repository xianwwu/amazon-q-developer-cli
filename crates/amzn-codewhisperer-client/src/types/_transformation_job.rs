...
impl TransformationJob {
    /// Creates a new builder-style object to manufacture [`TransformationJob`](crate::types::TransformationJob).
...
impl TransformationJobBuilder {
    ...
    /// Consumes the builder and constructs a [`TransformationJob`](crate::types::TransformationJob).
