...
impl DocV2AcceptanceEvent {
    /// Creates a new builder-style object to manufacture [`DocV2AcceptanceEvent`](crate::types::DocV2AcceptanceEvent).
...
impl DocV2AcceptanceEventBuilder {
    ...
    /// Consumes the builder and constructs a [`DocV2AcceptanceEvent`](crate::types::DocV2AcceptanceEvent).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DocV2AcceptanceEvent, ::aws_smithy_types::error::operation::BuildError> {
