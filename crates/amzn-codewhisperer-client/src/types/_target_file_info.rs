...
impl TargetFileInfo {
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.code_references.is_none()`.
...
impl TargetFileInfo {
    /// Creates a new builder-style object to manufacture [`TargetFileInfo`](crate::types::TargetFileInfo).
...
impl TargetFileInfoBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_code_references`](Self::set_code_references).
    ///
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_code_references(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Reference>>) -> Self {
