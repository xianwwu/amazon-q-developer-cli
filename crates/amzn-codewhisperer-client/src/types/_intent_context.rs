...
impl IntentContext {
    ...
    /// Tries to convert the enum instance into [`Documentation`](crate::types::IntentContext::Documentation), extracting the inner [`DocumentationIntentContext`](crate::types::DocumentationIntentContext).
