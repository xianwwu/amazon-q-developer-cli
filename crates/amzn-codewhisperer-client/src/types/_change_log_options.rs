...
impl ChangeLogOptions {
    /// Creates a new builder-style object to manufacture [`ChangeLogOptions`](crate::types::ChangeLogOptions).
...
impl ChangeLogOptionsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ChangeLogOptions, ::aws_smithy_types::error::operation::BuildError> {
