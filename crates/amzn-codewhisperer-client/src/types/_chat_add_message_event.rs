...
impl ChatAddMessageEvent {
    ...
    #[allow(missing_docs)] // documentation missing in model
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.time_between_chunks.is_none()`.
...
impl ChatAddMessageEvent {
    /// Creates a new builder-style object to manufacture [`ChatAddMessageEvent`](crate::types::ChatAddMessageEvent).
...
impl ChatAddMessageEventBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_time_between_chunks`](Self::set_time_between_chunks).
    ///
    ...
    /// Consumes the builder and constructs a [`ChatAddMessageEvent`](crate::types::ChatAddMessageEvent).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ChatAddMessageEvent, ::aws_smithy_types::error::operation::BuildError> {
