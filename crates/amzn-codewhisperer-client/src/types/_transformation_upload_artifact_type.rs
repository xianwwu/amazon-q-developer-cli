...
/// When writing a match expression against `TransformationUploadArtifactType`, it is important to ensure
...
impl ::std::convert::From<&str> for TransformationUploadArtifactType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformationUploadArtifactType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
