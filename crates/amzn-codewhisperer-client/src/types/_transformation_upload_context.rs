...
impl TransformationUploadContext {
    /// Creates a new builder-style object to manufacture [`TransformationUploadContext`](crate::types::TransformationUploadContext).
...
impl TransformationUploadContextBuilder {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_upload_artifact_type(mut self, input: ::std::option::Option<crate::types::TransformationUploadArtifactType>) -> Self {
    ...
    /// Consumes the builder and constructs a [`TransformationUploadContext`](crate::types::TransformationUploadContext).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TransformationUploadContext, ::aws_smithy_types::error::operation::BuildError> {
