...
impl AppStudioState {
    /// Creates a new builder-style object to manufacture [`AppStudioState`](crate::types::AppStudioState).
...
impl AppStudioStateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AppStudioState, ::aws_smithy_types::error::operation::BuildError> {
