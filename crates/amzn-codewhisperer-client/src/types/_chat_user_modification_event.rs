...
impl ChatUserModificationEvent {
    /// Creates a new builder-style object to manufacture [`ChatUserModificationEvent`](crate::types::ChatUserModificationEvent).
...
impl ChatUserModificationEventBuilder {
    ...
    /// Consumes the builder and constructs a [`ChatUserModificationEvent`](crate::types::ChatUserModificationEvent).
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ChatUserModificationEvent, ::aws_smithy_types::error::operation::BuildError> {
